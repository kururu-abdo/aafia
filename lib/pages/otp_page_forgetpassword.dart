...
class OtpPageForgetPassword extends BaseRoute {
final String?  phoneNumber;
final Function(String ,String)? onNavigate;

   OtpPageForgetPassword({ Key? key, this.phoneNumber, 
  this.onNavigate }) : super(r: 'key');

  @override
  _OtpPageState createState() => _OtpPageState(
    phoneNumber , onNavigate 
  );
}
...
final Function(String , String)? onNavigate;
  ...
  _OtpPageState(this.phoneNumber, this.onNavigate);
 _init() async {
    try {
...
_onVerifiyOtp()async{
  try {
    ...
    await apiHelper.verifyOTP(phoneNumber!.toString(), _cOtp.text.trim()).then((result) {
hideLoader();
...
// if (result!=null) {
  if (result.data!=null) {
    ...
    //   ()=>DashboardPage()
    // );
    onNavigate!(_cOtp.text.trim() ,result.data['user_id'].toString());
  // }
//   }else {
// log('message');
//   showSnackBar(
