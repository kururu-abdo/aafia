...
class AddBloodTransitionDonation extends BaseRoute {
  final String?  operationType;
  final PageMode? pageMode;
  final blood.Data?  data;
   AddBloodTransitionDonation(this.operationType, { Key? key
...
title: Text(tr('blood_tranfusion_request') ,style: TextStyle(
  ...
  setState(() {
    ...
    _dateController.text =requestTimeFormat(_requestDate!);
                              ...
                              }, currentTime: DateTime.now(), locale: context.locale==Locale('ar')
